...
use App\Http\Controllers\OngImpactoController;


//Rutas Públicas

Route::get('/', fn() => view('welcome'))->name('home');
Route::get('/impacto', [ImpactoController::class, 'index'])->name('impacto');
Route::get('/organizaciones', [App\Http\Controllers\OrganizacionesPublicasController::class, 'index'])->name('organizaciones.publicas');
Route::get('/proveedores', [App\Http\Controllers\ProveedoresPublicosController::class, 'index'])->name('proveedores.publicas');
...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('ong')->name('ong.')->middleware('role:organizacion')->group(function () {
        ...
        Route::get('/proveedores',    [App\Http\Controllers\OrganizacionController::class, 'listarProveedores'])->name('proveedores');
        ...
        Route::get('/dashboard',             [OrganizacionController::class, 'dashboard'])->name('dashboard');
        
        // CRUD de Historias de Impacto para la ONG
        Route::get('/impactos', [OngImpactoController::class, 'index'])->name('impactos');
        Route::post('/impactos/guardar', [OngImpactoController::class, 'store'])->name('impactos.store');
        Route::put('/impactos/actualizar/{id}', [OngImpactoController::class, 'update'])->name('impactos.update');
        Route::delete('/impactos/eliminar/{id}', [OngImpactoController::class, 'destroy'])->name('impactos.destroy');
